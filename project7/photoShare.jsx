        ...
        <Grid item sm={9}>
          <Paper className="cs142-main-grid-item">
            <Switch>
              ...
              {this.state.loginFlag ? <Route path="/photos/:userId" render ={ props => <UserPhotos {...props} uploadFlag={this.state.uploadFlag} handleUploadChange={this.handleUploadFlag}/> }/> : <Redirect path="/photos/:userId" to="/" />}
